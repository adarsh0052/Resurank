      ...
      <div className="login-wrapper">
        ...
        <div className="login-right">
          <div className="login-card">
            <h1 className="login-title" style={{ textAlign: 'center', marginBottom: '1rem',color:'#ffffff '}}>Log In</h1>
            <form onSubmit={handleSubmit}>
              <div className="input-field">
                <label htmlFor="email" className="label " style={{color:"#ffffff"}}>
                  Email
                </label>
                <input
                  type="email"
              ...
              <div className="input-field">
                <label htmlFor="password" className="label"style={{color:"#ffffff"}}>
                  Password
                </label>
                <input
                  type="password"
