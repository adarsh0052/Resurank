    ...
    <header className="sticky top-0 z-50 w-full glass-panel border-b border-slate-900/[0.06]">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-6 sm:px-8" style={{ height: '72px' }}>
        ...
        <Link to="/" className="flex items-center gap-3 group">
          <div className="flex h-9 w-9 items-center justify-center bg-slate-950 text-white transition-transform duration-300 group-hover:rotate-6">
          ...
          <span className="text-[14px] font-bold tracking-widest uppercase text-slate-950">
